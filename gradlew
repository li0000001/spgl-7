...
#       not govern to be POSIX compliant, but you have some other compliant shell
#       available, you may specify it as the first argument to sh, like this:
#
#        sh /path/to/gradlew <args>
#
#   (2) The slightest modification of the scripts will make them
#       invalid and unexecutable until corrected.
#
#   (3) This script is generated from the Gradle template
#       https://github.com/gradle/gradle/blob/master/subprojects/plugins/src/main/resources/org/gradle/api/plugins/launch_scripts/unix/gradle.sh
